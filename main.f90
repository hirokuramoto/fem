program main
  ...
  ! データファイルの読み込み
  call datain7(nnode, coords, nelem, lnods, n_bc_given, i_bc_given, n_bc_nonzero, i_bc_nonzero, v_bc_nonzero, icase, nint, ntnoel)

  ! 剛性マトリックスの作成
  call stiff7(a, b, nnode, coords, nelem, lnods, astiff, c, nint, ntnoel)
